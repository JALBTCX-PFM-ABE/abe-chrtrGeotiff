...
QString transparentText = 
  surfacePage::tr ("Selecting this option will cause all empty cells to be set to transparent (alpha channel) in the "
                   "output GeoTIFF.  If you do not select this then all empty cells will be blank.  Using a viewer "
                   "(like <b>qGIS</b>) will display empty cells as black.  In <b>CARIS</b> empty cells will "
...
QString carisText = 
  surfacePage::tr ("This check box will force the output to be unblocked and use <b>PACKBITS</b> compression "
...
QString dumbText = 
  surfacePage::tr ("Checking this box indicates that you want to convert <b><i>nominal</i></b> depths in meters collected at 1500 meters per second to "
                   ...
                   "<b>IMPORTANT NOTE: If you were not using <i>nominal</i> depth when you built this CHRTR file do not select this option.</b>");
...
QString elevText = 
  surfacePage::tr ("Checking this box indicates that you want the data to be output as elevation instead of depth.  This is assuming that the "
                   "CHRTR file was loaded with depth data (positive Z down).  If it was loaded with elevation data (positive Z up) then this will convert "
                   "it to depth before writing the geoTIFF (and optional contour) file(s).");

QString intervalText = 
  surfacePage::tr ("Select a contour interval for use in generating an ESRI SHAPE file containing the contours.  If you set this value to 0.0 "
                   "no contour files will be generated.  Contours will be in the units selected for the geoTIFF.  The name of the ESRI SHAPE file "
                   "will be the same as the geoTIFF file but with a .shp extension.  There will also be a .shx, .dbf, and .prj file "
                   "generated.");
